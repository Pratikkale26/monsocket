...
export const CABINETS: Cabinet[] = [
  ...
  },
  {
    id: "bloom",
    name: "Bloom",
    tagline: "Take ground on a shared board. One move per Monad block.",
    kind: "realtime territory",
    players: "2–8 players",
    hue: 88,
    status: "live",
    Preview: lazy(() => import("../games/bloom/BloomPreview")),
    Game: lazy(() => import("../games/bloom/Bloom")),
  },
  {
    id: "next",
    name: "Cabinet 03",
